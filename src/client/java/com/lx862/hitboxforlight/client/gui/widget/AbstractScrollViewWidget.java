...
public abstract class AbstractScrollViewWidget extends AbstractWidget {
    ...
    private void renderScrollbar(GuiGraphics guiGraphics, boolean isMouseOverScrollbar) {
        ...
        GuiHelper.drawRectangle(guiGraphics, getX() + getWidth() - SCROLLBAR_WIDTH, getY() + yOffset, SCROLLBAR_WIDTH, scrollbarHeight, isMouseOverScrollbar ? GuiHelper.ARGB_WHITE : 0xFFC0C0C0);
