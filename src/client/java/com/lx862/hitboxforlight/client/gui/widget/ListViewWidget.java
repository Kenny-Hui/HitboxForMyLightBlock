...
public class ListViewWidget extends AbstractScrollViewWidget {
    ...
    public void renderContent(GuiGraphics guiGraphics, int mouseX, int mouseY, float tickDelta) {
        ...
        for (AbstractListItem abstractListItem : displayedEntryList) {
            ...
            if (abstractListItem instanceof ContentItem) {
                ...
                boolean topLeftVisible = GuiHelper.inRectangle(contentItem.widget.getX(), contentItem.widget.getY(), getX(), getY(), getWidth(), getHeight());
                boolean bottomRightVisible = GuiHelper.inRectangle(contentItem.widget.getX() + contentItem.widget.getWidth(), contentItem.widget.getY() + contentItem.widget.getHeight(), getX(), getY(), getWidth(), getHeight());
